# Construcción de System Maps As-Is

## Contexto

Con el siguiente prompt para **System Maps As-Is**, se está abarcando generar un concepto y proposito para la solución con inteligencia artificial en el sector agricola colombiano, especificamente para los departamentos de Antioquia, Valle del Cauca y Cundinamarca. Para ello, el prompt tomará como base de conocimiento el resultado generado en [1_arquetipo_resultdado.md](1_arquetipo_resultado.md) y realizará una investigación sobre:
- **Fase 1:** Investigación del ecosistema actual
- **Fase 2:** Mapeo detallado del sistema AS-IS
- **Fase 3:** Análisis profundo y validación (4 sub-análises integrados)
...
```markdown
# UX AgroTech Research - System Maps As-Is
